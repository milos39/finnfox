    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.PromenaId)
                .ForeignKey("dbo.TipRacunovodstvenePromene", t => t.TipPromeneId, cascadeDelete: true)
                .Index(t => t.TipPromeneId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.RacunovodstvenaPromena", "TipPromeneId", "dbo.TipRacunovodstvenePromene");
            ...
            DropIndex("dbo.RacunovodstvenaPromena", new[] { "TipPromeneId" });
            DropTable("dbo.AspNetUserLogins");
            DropTable("dbo.AspNetUserClaims");
            DropTable("dbo.AspNetUsers");
            DropTable("dbo.AspNetUserRoles");
            DropTable("dbo.AspNetRoles");
            DropTable("dbo.TipRacunovodstvenePromene");
            DropTable("dbo.RacunovodstvenaPromena");
        }
    }
}
